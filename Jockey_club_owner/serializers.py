...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id','Name','email','phone','Gender','Dob','profile_picture','Introduction_voice','Introduction_text','National_ID','Pan_Card','Bank_Acc_Details','UPI_Address','Paytm_Address','uid')
