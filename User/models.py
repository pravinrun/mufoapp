...
# from django.db import models
# from djsms.models import TextMessage  # Assuming TextMessage model is defined in djsms app

# class Notification(models.Model):
#     text_message = models.OneToOneField(TextMessage, on_delete=models.CASCADE)
#     created_at = models.DateTimeField(auto_now_add=True)

#     def __str__(self):
#         return f"Notification for TextMessage: {self.text_message}"
